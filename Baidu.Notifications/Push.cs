...
namespace Baidu.Notifications
{
    public class Push
    {
        ...
        public Push(string httpMehtod, string secret_key)
        {
        ...
        public string PushMessage(Options opts)
        {
            ...
            //将键值对按照key的升级排列
            var props = typeof(Options).GetProperties().OrderBy(p => p.Name);
